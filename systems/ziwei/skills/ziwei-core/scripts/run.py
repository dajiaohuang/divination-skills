...
from systems.ziwei.core import analyze_core  # noqa: E402
from systems.ziwei.engine import calculate  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Explain project-native Ziwei structure.")
    ...
    parser.add_argument("--locale", choices=("zh-Hans", "zh-Hant", "en"), default="zh-Hans")
    ...
    print(
        json.dumps(
            analyze_core(calculate(payload), locale=args.locale),
            ensure_ascii=False,
            indent=2,
        )
    )
