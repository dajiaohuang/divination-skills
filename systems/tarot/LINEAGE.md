...
`rws-text-baseline-v0.1` uses the conventional 22 Major and 56 Minor Arcana names and ordering associated with Rider–Waite–Smith practice, but all stored keyword phrases are newly authored for this project. No card art is bundled.
